...
import { parseMoz } from './moz_parse.mjs?v=3.88';
import { buildJobZip, APP_VERSION as MOZ_BUILD_VERSION } from './moz_build.mjs?v=3.88';
import { CRATE_BY_KEY, CRATE_SHELL } from './crate_parts.mjs?v=3.88';
